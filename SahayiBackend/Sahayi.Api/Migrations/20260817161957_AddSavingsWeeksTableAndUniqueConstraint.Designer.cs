...
namespace Sahayi.Api.Migrations
{
    ...
    [Migration("20260817161957_AddSavingsWeeksTableAndUniqueConstraint")]
    partial class AddSavingsWeeksTableAndUniqueConstraint
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sahayi.Api.Entities.SavingsTransaction", b =>
                {
                    ...
                    b.HasIndex("SavingsWeekId", "UserId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Sahayi.Api.Entities.SavingsWeek", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("UnitId", "WeekNumber")
                        .IsUnique();

                    b.ToTable("SavingsWeeks");
                });

            modelBuilder.Entity("Sahayi.Api.Entities.UnitBankAccount", b =>
                {
            ...
            modelBuilder.Entity("Sahayi.Api.Entities.SavingsTransaction", b =>
                {
                    ...
                    b.HasOne("Sahayi.Api.Entities.SavingsWeek", "SavingsWeek")
                        .WithMany("SavingsTransactions")
                        .HasForeignKey("SavingsWeekId")
